...
- **Governing-law jurisdiction.** ToS says Texas / Travis County. Picked that because it's the canonical "tech-friendly red state" jurisdiction and a default for many software ToS templates. If you want a different jurisdiction (Wyoming for the LLC formation later, Delaware for the C-corp path, etc.), tell me and I'll swap.
